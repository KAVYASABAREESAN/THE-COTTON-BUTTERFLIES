...
const tourExperience = {
  ...
  helperText:
    'Move through the boutique with your mouse or finger and explore the shop at your own pace.'
};
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-6 text-4xl font-serif font-light leading-tight text-gray-900 md:text-6xl">
                Step inside the boutique from anywhere.
              </h1>
              <p className="mt-6 max-w-xl text-lg leading-8 text-gray-600">
                The virtual-tour experience is available for deployment now. The separate video
                walkthrough has been left out so the site can ship without the oversized media files.
              </p>
              ...
              <div className="mt-8 rounded-[1.75rem] border border-white/70 bg-white/80 p-6 shadow-[0_25px_70px_rgba(15,23,42,0.12)] backdrop-blur">
                <p className="text-sm font-semibold uppercase tracking-[0.22em] text-gray-500">
                  {tourExperience.badge}
                </p>
                <h2 className="mt-3 text-3xl font-serif font-light text-gray-900">
                  {tourExperience.title}
                </h2>
                <p className="mt-3 text-base leading-7 text-gray-600">
                  {tourExperience.description}
                </p>
                <div className="mt-6 flex flex-wrap gap-4">
                  <a
                    href={tourExperience.url}
                    target="_blank"
                    rel="noreferrer"
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/70 bg-white/80 p-3 shadow-[0_30px_80px_rgba(15,23,42,0.16)] backdrop-blur">
                <img
                  src={tourExperience.previewImage}
                  alt={`${tourExperience.title} preview`}
      ...
      <section className="container-custom py-8 md:py-12">
        <div className="overflow-hidden rounded-[2rem] border border-gray-200 bg-white shadow-xl">
          <div className="flex flex-col gap-4 border-b border-gray-200 px-6 py-5 md:flex-row md:items-center md:justify-between">
            <div>
              <h2 className="text-2xl font-serif font-light text-gray-900">{tourExperience.title}</h2>
              <p className="mt-1 text-sm text-gray-600">{tourExperience.helperText}</p>
            </div>
            <a
              href={tourExperience.url}
              target="_blank"
          ...
          <div className="bg-black">
            <iframe
              title={tourExperience.embedTitle}
              src={tourExperience.url}
